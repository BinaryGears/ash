...
impl DeviceGroup {
    ...
    /// Also available as [`super::Swapchain::get_device_group_present_capabilities()`] since Vulkan 1.1.
    ///
    ...
    /// Also available as [`super::Swapchain::get_device_group_surface_present_modes()`] since Vulkan 1.1.
    ///
    ...
    /// Also available as [`super::Swapchain::get_physical_device_present_rectangles()`] since Vulkan 1.1.
    ///
    ...
    ///
    /// Also available as [`super::Swapchain::acquire_next_image2()`] since Vulkan 1.1.
    ///
